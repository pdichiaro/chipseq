...
The `custom_content.order` section matches the exact file patterns generated by the pipeline:
```yaml
custom_content:
  order:
...
**Important**: These patterns must match the actual filenames generated by the DESEQ2_TRANSFORM module:
- Plots 01-04: `all_genes` normalization
- Plots 05-08: `invariant_genes` normalization
